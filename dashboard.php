		...
		<div class="main-panel">
			<div class="content">
				...
				<div class="page-inner mt--2">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="card card-stats card-round" style="background-color:#8F758E; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
						...
						<div class="col-md-4">
							<div class="card card-stats card-round" style="background-color:#524A4E; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
						...
						<div class="col-md-4">
							<div class="card card-stats card-round" style="background-color:#D1512D; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="card card-stats card-round" style="background-color:#9D8221; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
						...
						<div class="col-md-4">
							<div class="card card-stats card-round" style="background-color:#334756; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
						...
						<div class="col-md-4">
							<div class="card card-stats card-round" style="background-color:#678983; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												...
												<h3 class="fw-bold text-uppercase">₱ <?= number_format($revenue['am'],2) ?></h3>	
											</div>
										</div>
									</div>
								</div>
