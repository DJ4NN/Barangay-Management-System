											...
											<tbody>
												<?php if(!empty($resident)): ?>
													...
													<tr>
                                                        ...
                                                        <!-- <td style="width:100px";><?= $formattedNumber ?></td>														 -->
														<td><?= $row['birthdate'] ?></td>
														<td><?= $row['age'] ?></td>
														...
														<td>
															<div class="form-button-action">
                                                                <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="View Resident" onclick="editResident(this)" 
                                                                    ...
                                                                    data-img="<?= $row['picture'] ?>" data-citi="<?= $row['citizenship'];?>" data-occu="<?= $row['occupation'] ?>" data-dead="<?= $row['resident_type'];?>">
                                                                    <?php if(isset($_SESSION['username'])): ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input onBlur='addDashes(this)' type="number" class="form-control" name="national" id="nat_id" onKeyPress="if(this.value.length==16) return false;" placeholder="Enter National ID No.">
                                    </div> -->
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type = "number" class="form-control" min="0" onKeyPress="if(this.value.length==11) return false;"  placeholder="Enter Contact Number" name="tel" id="tel">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div id="my_camera1" style="width: 370px; height: 250;" class="text-center">
                                        <img src="assets/img/person.png" alt="..." class="img img-fluid" width="250" id="image" style="height: 250px;">
                                    </div>
                                    <?php if(isset($_SESSION['username'])):?>
                                    <div class="form-group d-flex justify-content-center">
