	...
	if($national_id['id'] == $id || count($national_id) <= 0){
		if(!empty($id)){
			...
			if(!empty($profile) && !empty($profile2)){
				...
				$query = "UPDATE tblresident SET national_id='$national_id',citizenship='$citi',`picture`='$profile', `firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `birthplace`='$bplace', `birthdate`='$bdate', 
				...
				$query = "UPDATE tblresident SET national_id='$national_id',citizenship='$citi',`picture`='$newName', `firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `birthplace`='$bplace', `birthdate`='$bdate', 
							age=$age, `civilstatus`='$cstatus', `gender`='$gender', `purok`='$purok', `voterstatus`='$vstatus', `identified_as`='$indetity', `phone`='$number', `email`='$email',`occupation`='$occu', `address`='$address',
							`resident_type`='$deceased'
							WHERE id=$id;";
				...
				$query = "UPDATE tblresident SET national_id='$national_id',citizenship='$citi',`firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `birthplace`='$bplace', `birthdate`='$bdate', 
							age=$age, `civilstatus`='$cstatus', `gender`='$gender', `purok`='$purok', `voterstatus`='$vstatus', `identified_as`='$indetity', `phone`='$number', `email`='$email',`occupation`='$occu', `address`='$address',
							`resident_type`='$deceased',
							WHERE id=$id;";
