                                    ...
                                    <div class="row mt-2">
                                        <div class="">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <h2 class="mt-4 ml-5">TO WHOM IT MAY CONCERN:</h2>
                                                <h2 class="mt-4 mx-5" style="text-indent: 40px;">This is to certify that <span class="fw-bold" style="font-size:25px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, is a permanent resident of 
                                                ...
                                                <h2 class="mt-4 mx-4" style="text-indent: 40px;">This certification/clearance is hereby issued to the above-named person for whatever legal purpose it may serve him/her best.</h2>
                                                <h2 class="mt-5 ml-5">Given this <span class="fw-bold" style="font-size:25px"><?= date('m/d/Y') ?>.</span></h2>   
                                                <h2 class="text-uppercase text-right mb-4 mr-5" style="margin-top:160px;">NOT VALID WITHOUT SEAL:</h2>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="p-3 text-left mt-5 mr-3">
                                        ...
                                        <div class="col-md-12 d-flex flex-wrap justify-content-end">
                                            <div class="p-3 text-center">
                                                <div class="border mb-5" style="height:150px;width:290px">
                                                    <p class="mt-5 mb-4 pt-5">Right Thumb Mark</p>
                                                </div>
                                                <h2 class="fw-bold mt-4 mb-0"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></h2>
