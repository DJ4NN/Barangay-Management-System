						...
						<div class="col-md-12">
                            ...
                            <div class="card">
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-3">
                                            <div class="text-center" style="border:1px solid red; width:60%;">
                                                <img src="<?= preg_match('/data:image/i', $resident['picture']) ? $resident['picture'] : 'assets/uploads/resident_profile/'.$resident['picture'] ?>" alt="Resident Profile" class="img-thumbnail" style="height: 250px; width: 100%;">
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="row">
